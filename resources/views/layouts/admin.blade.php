        ...
        <header class="navbar navbar-expand-md navbar-light shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <h1 class="text-success">Boolfolio</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto text-success">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}" class="text-success">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}"
                                        class="text-success">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
